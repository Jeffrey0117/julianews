    ...
    const template = `
        <div class="fixed-buttons flex items-center flex-col fixed z-50 md:right-[4rem] right-[2rem] md:bottom-[4rem] bottom-[2rem]">
            ...
            <button id="service-toggle-btn"
                class="service-btn group md:mt-[1.5rem] mt-[0.8rem] size-[4.5rem] bg-black hover:bg-[#DBC8B7] transition-all duration-300 flex items-center justify-center rounded-full border border-black hover:border-[#DBC8B7] cursor-pointer"
            ...
            <div id="service-list" class="service-list">
                ...
                <a href="${CONFIG.igLink}" target="_blank"
                    class="group md:mt-[1.5rem] mt-[0.8rem] size-[4.5rem] bg-black hover:bg-[#DBC8B7] transition-all duration-300 flex items-center justify-center rounded-full border border-black hover:border-[#DBC8B7]">
            ...
            <!-- 回到頂部 -->
            <button class="group md:mt-[1.5rem] mt-[0.8rem] got_to_top overflow-hidden cursor-pointer size-[4.5rem] bg-white hover:bg-[#DBC8B7] transition-all duration-300 flex items-center justify-center rounded-full border border-[#000000] hover:border-[#DBC8B7]">
                <svg class="w-[1.6rem]" width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 7L8 1L0.999999 7" stroke="#DBC8B7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="stroke-[#000000] group-hover:stroke-white transition-colors duration-300" />
                </svg>
            </button>
        </div>
    `;
